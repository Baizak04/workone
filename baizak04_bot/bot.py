...
#             bot.edit_message_text(chat_id=call.message.chat.id, message_id=call.message.chat.id, text= 'хорошо 😁')
#         if call.data == 'goodbye':
#             bot.edit_message_text(chat_id=call.message.chat.id, message_id=call.message.chat.id, text= 'удачи тебе 👋')
